...
export function upsertSelectedTopic(date, topic, { root = ROOT } = {}) {
  ...
  const next = compactObject({
    ...
    content_lane: topic.content_lane || existing?.content_lane || '',
    content_archetype: topic.content_archetype || existing?.content_archetype || '',
    diversity_note: topic.diversity_note || existing?.diversity_note || '',
    diversity_penalty: topic.diversity_penalty ?? existing?.diversity_penalty ?? null,
    recent_similarity: topic.recent_similarity ?? existing?.recent_similarity ?? null,
...
function normalizeTopic(topic) {
  return compactObject({
    ...
    content_lane: topic.content_lane || '',
    content_archetype: topic.content_archetype || '',
    diversity_note: topic.diversity_note || '',
    diversity_penalty: topic.diversity_penalty ?? null,
    recent_similarity: topic.recent_similarity ?? null,

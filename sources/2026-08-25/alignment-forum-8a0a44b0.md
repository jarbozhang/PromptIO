...
url: 'https://www.alignmentforum.org/posts/vLFh8HP3hyNy9MCwe/returning-to-arc'
source: Alignment Forum
source_type: rss
language: en
published: '2026-08-04T22:27:40.000Z'
...
Modern AI systems are not aligned with human intent. We will likely train increasingly powerful models that take unintended actions in order to succeed at their task (or appear to succeed at their task). Developers can create environments that penalize bad behavior and then train or hill-climb on those environments. Unfortunately this could lead to models that still seek reward but simply try harder to avoid being penalized for bad behavior; the last few years of evidence have only made that failure look more li

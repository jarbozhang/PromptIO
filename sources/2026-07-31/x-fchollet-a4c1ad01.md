---
title: >-
  Quick reminder of what's ok vs not ok with harnesses used for playing
  ARC-AGI-3: 1. Not okay: harnesses that were custom-made to solve the benchmark
  or that contain knowledge about
source: X @fchollet
url: 'https://x.com/fchollet/status/2082732210436575669'
date: 'Thu Jul 30 07:37:08 +0000 2026'
likes: 955
reposts: 40
replies: 82
source_type: x
...
2. Fine: general-purpose API settings that were not developed for ARC-AGI-3 and that are available to all API users.

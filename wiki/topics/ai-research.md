...
| 日期 | 文章 | 角度 |
|------|------|------|
| 2026-05-13 | [[nathan-lambert-end-of-finetuning-rag-vs-长上下文\|OpenAI 砍 finetuning API，Nathan Lambert 那条"中国 lab 还在 RLFT"的注脚怎么读]] | 7 |
...
| 2026-05-21 | [[openai-证否-erdős-80年-单位距离猜想-1000美元\|OpenAI 新模型证否 80 年 Erdős 单位距离猜想 算力成本不到 1000 美元]] | AI for Science / 数学证否 / 推理模型成本 |

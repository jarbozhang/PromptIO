...
| [[ai-video\|AI 视频]] | **2** | **1%** | **4/24 +1 篇（Open-Generative-AI 包含视频模型）。归入 AI 视频与 AI 设计/生图交叉** |
| [[ocr\|OCR]] | 1 | 1% | 4/24 无新增 |
| [[ai-search\|AI 搜索]] / 浏览器 AI | 1 | 1% | 4/24 无新增 |
| 信息聚合 | 2 | 1% | 4/24 无新增 |
| [[embodied-ai\|具身智能]] | **1** | **1%** | **4/24 首次落地覆盖（Gemma 4 + Jetson Orin Nano VLA 桌面机器人），具身智能从概念段进入 2000 元级可复现段** |
...
| 主题 | 篇数 | 备注 |
|------|------|------|
| [[ai-pricing\|AI 定价]] | 3 | DeepSeek V4 Flash 每 M 一毛钱 / 腾讯 Hy3 + 蚂蚁 Ling-2.6-1T 免费 / Open-Generative-AI 替 Midjourney 订阅 |
| [[local-inference\|本地推理]] | 3 | DeepSeek V4 Flash 本地可跑 / Gemma 4 on Jetson Orin Nano / Qwen3.6-27B Dense 本地显卡可用 |
| 国产AI生态 | 3 | DeepSeek V4 双发 / 腾讯 Hy3 + 蚂蚁 Ling-2.6-1T 万亿免费 / Qwen3.6-27B 本地旗舰 |
| [[ai-coding-tools\|AI 编程工具]] | 2 | Claude Code 变笨 retro + Opus 4.7 system prompt 拆解 / Qwen3.6-27B Dense 编程旗舰 |
| [[agent-frameworks\|Agent 框架]] | 1 | 腾讯 Hy3 agentic 万亿 + 蚂蚁 Ling 双万亿免费 |
| [[multimodal\|多模态]] | 1 | Gemma 4 VLA（视觉语言动作）多模态端侧 |
| [[ai-security\|AI 安全]] | 1 | GPT-5.5 Bio Bug Bounty 2.5 万美元，从 Mythos 单线扩展 |
| [[ai-research\|AI 研究]] | 1 | GPT-5.5 System Card / 生物安全评估方法论 |
| [[ai-hardware\|AI 硬件]] | 1 | Jetson Orin Nano VLA 端侧算力入门机 |
| [[ai-education\|AI+教育]] | 1 | Chip Huyen AI Engineering 配套 repo + 600 页方法论新书 |
| AI 设计 | 1 | Open-Generative-AI 200 多个模型 MIT 开源，对标 Midjourney/Freepik |
| [[ai-video\|AI 视频]] | 1 | Open-Generative-AI 覆盖视频模型（归入视频与设计交叉） |
| [[embodied-ai\|具身智能]] | 1 | **首次落地覆盖**，Gemma 4 + Jetson Orin Nano 2000 元级 VLA 桌面机器人 |
...
2. **AI+医疗** — 2 篇，国产百图生科/晶泰实盘案例仍待深挖
3. **AI 金融/量化** — 2 篇，国产量化团队复现空间大
4. **[[embodied-ai\|具身智能]]** — 4/24 Gemma 4 Jetson VLA 首次落地后，国产宇树 / 小鹏 / 小米机器人 VLA 方案值得追
5. **AI 行业并购** — SpaceX/Cursor 开启，后续 AI 并购新闻可跟
6. **AI 移动开发** — Android CLI 首篇后仍有空间
7. **AI 训练数据 / 隐私边界** — Meta 录键鼠后国内平台跟进如何

**警告：AI 定价 13 篇 / 10%，国产连续两天在免费 / 降价侧发力，短期内建议降低此主题的盘点类再增速，仅在"重大价格断档事件"时才纳入。**
**警告：国产 AI 生态 4/23 +3、4/24 +3，连续两日各三篇集中出招，下一轮严格降权"国产同日合写"类选题。**
**警告：本地推理 9 篇/8%，Gemma 4 / Qwen3.6-27B / DeepSeek Flash 形成新基线，下一轮只跟"非 Gemma 非 Qwen 非 DeepSeek"的本地推理路线。**
**注意：AI 硬件 +1、AI 安全 +1、AI 研究 +1、AI+教育 +1，中等饱和线梯队稳固。**
**注意：具身智能从概念首次进入"2000 元可复现"阶段，是下一轮重点开拓方向。**

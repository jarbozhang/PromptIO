/last30days · researching: inclusionAI Ring thinking model OpenRouter
...
[Planner]   sq1 label=primary search="inclusionai ring thinking model openrouter" sources=[hackernews,reddit]
✓ Research complete (1.0s) - Reddit: 0 threads, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: inclusionAI Ring thinking model OpenRouter
...
⚠️  This run was called BARE on a named-entity topic ("inclusionAI Ring thinking model OpenRouter"):
...
then rerun `/last30days inclusionAI Ring thinking model OpenRouter`. The skill will resolve handles

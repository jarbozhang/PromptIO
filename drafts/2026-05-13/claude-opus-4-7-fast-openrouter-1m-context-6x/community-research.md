/last30days · researching: Claude Opus 4.7 Fast OpenRouter
...
[Planner]   sq1 label=primary search=""Claude Opus" "Fast Open" claude opus 4.7 fast openrouter" sources=[hackernews,reddit]
✓ Research complete (1.5s) - Reddit: 1 thread, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: Claude Opus 4.7 Fast OpenRouter
...
⚠️  This run was called BARE on a named-entity topic ("Claude Opus 4.7 Fast OpenRouter"):
...
### 1. Claude Limit Extender (score 0, 1 item, sources: Reddit)
1. [reddit] Claude Limit Extender
   - 2026-04-14 | r/ClaudeCode | [2pts, 30cmt] | score:0
   - URL: https://www.reddit.com/r/ClaudeCode/comments/1sldbox/claude_limit_extender/
   - Why: fallback-local-score (entity-miss demotion)
   - Evidence: Ok so I know people are complaining about the limit reductions. These aren't going away, no matter who unsubscribes or complains. The influx of consumer subs after the GPT exodus killed their compute capacity. They have to keep things running for the enterprise and API-only customers. Mythos is live. They don't make money off of subs. They most likely ove...

## Stats

- Total evidence: 1 item across 1 source
- Top voices: r/ClaudeCode
- Reddit: 1 item | 2pts, 30cmt | communities: r/ClaudeCode
...
then rerun `/last30days Claude Opus 4.7 Fast OpenRouter`. The skill will resolve handles
...
├─ 🟠 Reddit: 1 thread │ 2 upvotes │ 30 comments

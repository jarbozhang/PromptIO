/last30days · researching: Gemma 4 open weights
...
[Planner]   sq1 label=primary search="gemma 4 open weights" sources=[hackernews,reddit]
✓ Research complete (1.0s) - Reddit: 1 thread, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: Gemma 4 open weights
...
⚠️  This run was called BARE on a named-entity topic ("Gemma 4 open weights"):
...
### 1. Google Gave Away Private AI Agents: Gemma 4 Runs Offline on iPhone, What Can It Do? (score 0, 1 item, sources: Reddit)
1. [reddit] Google Gave Away Private AI Agents: Gemma 4 Runs Offline on iPhone, What Can It Do?
   - 2026-04-16 | r/AskClaw | [54pts, 17cmt] | score:0
   - URL: https://www.reddit.com/r/AskClaw/comments/1smr3ru/google_gave_away_private_ai_agents_gemma_4_runs/
   - Why: fallback-local-score (entity-miss demotion)
   - Evidence: The release of the Gemma 4 family is a DeepSeek moment.  Google finally responded to the absolute dominance of the Chinese llm models. At the current state this models are lobotomized, they are cool to showcase that local agentic LLMs are possible – even on a phone nowadays – but telling the people to "connect them to claude code to Have you actually chec...

## Stats

- Total evidence: 1 item across 1 source
- Top voices: r/AskClaw
- Reddit: 1 item | 54pts, 17cmt | communities: r/AskClaw
...
then rerun `/last30days Gemma 4 open weights`. The skill will resolve handles
...
├─ 🟠 Reddit: 1 thread │ 54 upvotes │ 17 comments
└─ 🗣️ Top voices: r/AskClaw
---

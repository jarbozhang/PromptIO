/last30days · researching: Chrome Skills AI prompt browser
...
[Planner]   sq1 label=primary search=""Chrome Skills" chrome ai browser" sources=[hackernews,reddit]
[RedditPublic] 403 forbidden: https://www.reddit.com/search.json?q=Chrome+Skills+AI+prompt+browser&sort=relevance&t=month&limit=10&raw_json=1
✓ Research complete (0.4s) - Reddit: 0 threads, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: Chrome Skills AI prompt browser
...
⚠️  This run was called BARE on a named-entity topic ("Chrome Skills AI prompt browser"):
...
then rerun `/last30days Chrome Skills AI prompt browser`. The skill will resolve handles

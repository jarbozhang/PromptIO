/last30days · researching: AI agent deleted production database
...
[Planner]   sq1 label=primary search="ai agent deleted production database" sources=[hackernews,reddit]
[RedditPublic] 403 forbidden: https://www.reddit.com/search.json?q=AI+agent+deleted+production+database&sort=relevance&t=month&limit=10&raw_json=1
✓ Research complete (0.2s) - Reddit: 0 threads, HN: 1 story, Github: 0 results
...
# last30days v3.0.0: AI agent deleted production database
...
⚠️  This run was called BARE on a named-entity topic ("AI agent deleted production database"):
...
### 1. An AI agent deleted our production database. The agent's confession is below (score 21, 1 item, sources: Hacker News)
1. [hackernews] An AI agent deleted our production database. The agent's confession is below
   - 2026-04-26 | Hacker News | [828pts, 996cmt] | score:21
   - URL: https://twitter.com/lifeof_jer/status/2048103471019434248
   - Why: fallback-local-score (entity-miss demotion)
   - Evidence: An AI agent deleted our production database. The agent's confession is below

## Stats

- Total evidence: 1 item across 1 source
- Top voices: Hacker News
- Hacker News: 1 item | 828pts, 996cmt | domains: Hacker News
...
then rerun `/last30days AI agent deleted production database`. The skill will resolve handles
...
└─ 🟡 HN: 1 story │ 828 points │ 996 comments
---

/last30days · researching: GPT-5.5 Instant ChatGPT default hallucination
...
[Planner]   sq1 label=primary search=""Instant Chat" gpt-5.5 instant chatgpt default hallucination" sources=[hackernews,reddit]
✓ Research complete (0.9s) - Reddit: 0 threads, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: GPT-5.5 Instant ChatGPT default hallucination
...
⚠️  This run was called BARE on a named-entity topic ("GPT-5.5 Instant ChatGPT default hallucination"):
...
then rerun `/last30days GPT-5.5 Instant ChatGPT default hallucination`. The skill will resolve handles

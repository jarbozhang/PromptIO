/last30days · researching: Cerebras IPO OpenAI compute partner
...
[Planner]   sq1 label=primary search="cerebras ipo openai compute partner" sources=[hackernews,reddit]
✓ Research complete (1.3s) - Reddit: 1 thread, HN: 0 stories, Github: 0 results
...
# last30days v3.0.0: Cerebras IPO OpenAI compute partner
...
⚠️  This run was called BARE on a named-entity topic ("Cerebras IPO OpenAI compute partner"):
...
### 1. Cerebras 35B + IPO 🚀🚀🚀 20B openAi deal 🤑🤑🤑 (score 0, 1 item, sources: Reddit)
1. [reddit] Cerebras 35B + IPO 🚀🚀🚀 20B openAi deal 🤑🤑🤑
   - 2026-04-17 | r/CerebrasSystems | [20pts, 16cmt] | score:0
   - URL: https://www.reddit.com/r/CerebrasSystems/comments/1snoci7/cerebras_35b_ipo_20b_openai_deal/
   - Why: fallback-local-score (entity-miss demotion)
   - Evidence: https://www.theinformation.com/briefings/cerebras-prepares-public-listing-eyes-35-billion-plus-valuation
...
- Top voices: r/CerebrasSystems
- Reddit: 1 item | 20pts, 16cmt | communities: r/CerebrasSystems
...
then rerun `/last30days Cerebras IPO OpenAI compute partner`. The skill will resolve handles
...
├─ 🟠 Reddit: 1 thread │ 20 upvotes │ 16 comments
└─ 🗣️ Top voices: r/CerebrasSystems
---
